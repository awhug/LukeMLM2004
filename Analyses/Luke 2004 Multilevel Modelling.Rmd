...
The described "Empirical Bayes" estimates are obtained via `coef()` in lme4. These go by various different terms, such as best linear unbiased estimators (BLUE) or predictor (BLUP), conditional mode of parameters by Doug Bates; in the text, Luke also refers to them as "shrinkage estimates". 
...
model4_fit <- glmer(vote ~ 1 + pactotal + party + (1 | legislator), 
                   data = tobacco_votes, 
                   family = binomial)
